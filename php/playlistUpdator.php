<?php
	$mainChannelScheduleURL = "https://lineup-lemfm-main.radiokitapp.org/api/lineup/v1.0/channel/main/playlist";
	$mainChannelSchedule15sURL = 'https://lineup-lemfm-main.radiokitapp.org/api/lineup/v1.0/channel/main/playlist?scope=current-15s';
