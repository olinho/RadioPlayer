...
function loadDelayedFunctions() {
	var el;
	try {
		el = getJQueryElementFromSVGdocument("playIcon");
	} catch (err){
		console.log("Error loadDelayedFunctions " + err);
		window.setTimeout(loadDelayedFunctions, 1000);
	}
...
function remindAboutPlayButton() {

}

function endAnimateKropka() {
	console.log('end animate kropka');
